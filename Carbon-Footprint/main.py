...
if but.button("Calculate Carbon Footprint!", type="primary",key="calculate"):
    click_element('tab-1')
_,col2,home = comps.columns([1,2,1])
if home.button("🏡"):
    click_element('tab-0')
...
if resultbutton.button("Predict", type = "secondary"):
...
if resultmid.button("Calculate Again", type="secondary"):
    click_element('tab-1')
